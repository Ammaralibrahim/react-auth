...
function Identity() {
  ...
  const [currentStep, setCurrentStep] = useState(1); // Şu anki adımı saklamak için bir durum
  const [formData, setFormData] = useState({
    // Form verilerini saklamak için bir durum
    firstName: "",
    lastName: "",
    email: "",
  ...
  // Her adımda form verilerini güncellemek için bir işlev
  ...
  // Sonraki adıma gitmek için bir işlev
  const nextStep = () => {
    setCurrentStep(currentStep + 1);
  };

  // Önceki adıma gitmek için bir işlev
  const prevStep = () => {
    setCurrentStep(currentStep - 1);
  };
      ...
      <div className="relative bg-gray-900 bg-opacity-75">
            ...
            <div className="w-full max-w-xl xl:px-8 xl:w-5/12">
              <div className="bg-black rounded-2xl	 shadow-2xl p-7 sm:p-10">
                ...
                >
                  ...
                  <label
                      htmlFor="username"
                      className="inline-block mb-1 font-medium text-white text-xs dark:text-gray-400" 
                    >
                     Kullanıcı Adı
                    </label>
                    <input
        ...
        <footer className="px-4 divide-y dark:bg-black dark:text-gray-100">
          <div className="container flex flex-col py-10 mx-auto  space-y-4 lg:flex-row">
            <div className="footer-logo lg:w-1/7 mr-10">
              <img
                src="./logo.png"
                alt="Company Logo"
          ...
          <div className="py-6 text-sm text-center dark:text-gray-400">
            <div className="flex flex-cols-2 text-sm  justify-between	">
              <div className="space-y-3 ml-3">
                <h3 className="tracki uppercase dark:text-gray-400">
